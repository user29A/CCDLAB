...
namespace CCDLAB
{
	public partial class Form1
	{
		...
		private void WCSAstroQueryFilterDrop_SelectedIndexChanged(object sender, EventArgs e)
		{
			JPFITS.REG.SetReg("CCDLAB", "WCSAstroQueryFilterDrop", WCSAstroQueryFilterDrop.SelectedIndex);
